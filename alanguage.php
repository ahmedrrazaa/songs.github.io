		...
		<div class="row">
						...
						<div class="col-md-4 text-center text-md-right">
							...
							Home
								...
								<li class="active">Music Language</li>
							</ol>
						</div>
					</div>
				</div>
...
$fetch = mysqli_query($con,"select * from language");
while ($a = mysqli_fetch_array($fetch)) {
      ...
      echo '            <div class="col-md-4 col-sm-6">
								...
								<div class="item-media-wrap"> <img src="images/albums/cd.png" alt="">
									...
									<div class="item-media"> <img style="height:250px; width:300px" src=../dashboard/img/'.$a["pic"].' alt="">
										<div class="media-links no-overlay">
											<div class="links-wrap"> <a href="atifaslam.php" class="p-link"></a> </div>
                            ...
                            <h4 class="entry-title topmargin_5"> <a href="single-album.php">'.$a["name"].'</a> </h4>
								</div>
							</div>
						</div>
						';
