               ...
               <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    echo      ' <tr>
                                 ...
                                 <td>
                                    <span class="table-remove"><a href="updateartist.php?updateId='.$data['id'].'"  class="btn bg-success-light btn-rounded btn-sm my-0">Update</a></span></td> 
                                       <td>
                                       <span class="table-remove"><a href="deleteartist.php?deleteId='.$data['id'].'"  class="btn bg-danger-light btn-rounded btn-sm my-0">Remove</a></span></td> 
