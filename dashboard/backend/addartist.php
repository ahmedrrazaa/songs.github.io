      ...
      || strtolower($ext) == "image/png")
          {
            ...
            $target ='../img/' . basename($imagename);
              ...
              {
      $insert = "INSERT INTO `artist`(`name`, `pic`, `description`) VALUES ('$name','$imagename','$desc')";
                              ...
                              <div class="row">
                                 <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control" name="desc" placeholder="url to its biography" />
                                    </div>
                                 </div>
                              </div>
