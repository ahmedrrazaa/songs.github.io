<?php
  ...
  $select = "SELECT * FROM `latesthomepage` WHERE id = $update";
      ...
      || strtolower($ext) == "video/mp4")
          {
            ...
            $target2 ='../video/' . basename($videoname);
              ...
              {
      $update = "UPDATE `latesthomepage` SET `name`='$name',`artist`='$art',`cover`='$imagename',`year`='$year',`file`='$audioname',`video`='$videoname' WHERE `latesthomepage`. `id` = $update";
      $run = mysqli_query($con, $update);
     header("location:latesthomepage-table.php");
                           ...
                           <div class="form-card text-left">
                              <div class="row">
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group">
                                       <label>Artist</label>
                                       <input type="text" class="form-control" name="art" placeholder="Artist" value="<?php echo $record[2] ?>" />
                                    </div>
                                 </div>
                                 <div class="col-md-6">
                                    <div class="form-group">
                                       <label>Year</label>
                                       <input type="number" class="form-control" name="year" placeholder="Enter Year" value="<?php echo $record[4] ?>" />
                                    </div>
                                 </div>
                              </div>
                              ...
                              <div class="form-group">
                                 ...
                                 <img src="../img/<?php echo $record[3] ?>" id="image"  alt="" width="120px" height="150px">
                              ...
                              <div class="form-group">
                                 ...
                                 <audio src="../audio/<?php echo $record[5] ?>" id="audio"  alt="" style="width: 300px; height: 30px;" controls></audio>
                              </div>
                              <div class="form-group">
                                 ...
                                 <video src="../video/<?php echo $record[6] ?>" id="video"  alt="" style="width: 150px; height: 150px;" controls></video>
                              </div>
                           </div>
