<?php
  ...
  $select = "SELECT * FROM `artist` WHERE id = $update";
      ...
      || strtolower($ext) == "image/png")
          {
            ...
            $target ='../img/' . basename($imagename);
              ...
              {
      $update = "UPDATE `artist` SET `name`='$name', `pic`='$imagename', `description`='$desc' WHERE `artist`. `id` = $update" ;
                              ...
                              <div class="row">
                                 <div class="col-md-6">
                                    <div class="form-group">
                                       <label>Name</label>
                                       <input type="text" class="form-control" value="<?php echo $record[1] ?>" name="name" placeholder="Artist Name" />
                                    </div>
                                    <div class="form-group">
                                       <label>Description</label>
                                       <input type="text" class="form-control" value="<?php echo $record[3] ?>" name="desc" placeholder="Biography" />
                                    </div>
                                 </div>
                              </div>
