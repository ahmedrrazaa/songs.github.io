...
<body>
	...
	<?php include('nav.php');?>
    <center><div><img src="img2.gif" alt="" style="height:300px;width:400px"></div></center>
    <div>
    ...
    <?php  
                    ...
                    echo      ' <tr>
                                <td style="color:white;">'.$data["id"].'</td>
                                 ...
                                 <td style="color:white;">'.$data["artist"].'</td>
                                 <td style="color:white;">'."<audio src='../dashboard/audio/".$data['file']." ' style='width: 450px; height: 30px;' controls type='video/mp3' ></audio>".'</td>
